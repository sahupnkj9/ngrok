...
CREATE INDEX idx_qr_sessions_teacher_subject ON qr_sessions(teacher_id, subject_id);
CREATE INDEX idx_student_subjects_enrollment ON student_subjects(student_id, academic_year, semester);
...
-- CREATE USER 'attendance_app'@'localhost' IDENTIFIED BY 'secure_password_here';
